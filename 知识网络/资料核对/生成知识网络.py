...
# 页码均为用户提供版本的书内页码；PDF 页序分别加 10、15。
topics = [
('01','设计准则与失效分析','基础',[(2,5)],[(1,1),(2,11)],
...
['给出轴、齿轮和滑动轴承各一种失效，并选择对应准则。','为什么强度合格的轴仍可能不能正常工作？','设计计算后将直径圆整，为什么还要校核？'],
['轴疲劳断裂→疲劳强度；齿面点蚀→接触疲劳强度；轴瓦磨损→条件性耐磨验算或润滑设计。','挠度或转角过大可能使啮合和支承工作不良；必要时还要检查振动稳定性。','圆整和结构细化会改变截面、应力集中、配合及有关参数。']),
('02','疲劳强度与接触强度','基础',[(3,27)],[(2,11),(3,36)],
...
['恒定横向力作用下匀速旋转轴的弯曲应力通常是什么循环？','轴肩圆角增大主要改善哪一环节？','工作应力增长时为什么不能一律沿原点射线？'],
['对随轴旋转的表面材料点，在通常简化模型中为对称循环。','减轻应力集中；还需保证与相邻零件倒角、定位结构相容。','只有 r 不变时平均应力与应力幅同比增长；其他约束对应其他路径。']),
('03','材料热处理与制造工艺','基础',[(2,21)],[(5,79)],
...
['提高轴的材料强度能否直接解决挠度过大？','齿轮为什么可能要求表面硬而心部有韧性？','为什么设计时要考虑刀具退出与装配顺序？'],
['一般不能；需检查几何尺寸、支承布局以及弹性模量。','表面承受接触和磨损，心部承担弯曲并抵抗冲击。','结构必须能加工、能装入、能定位并能拆卸维护。']),
('04','摩擦磨损与润滑','基础',[(4,53)],[(4,58)],
...
['带与带轮工作面能否照搬齿轮的加油思路？','黏度提高为何不一定使效率提高？','动压轴承停车时承载油膜为什么会改变？'],
['不能，摩擦带传动需要足够摩擦力，污染工作面可能削弱传力。','黏性摩擦损失可能增加，并引起温升。','相对运动减弱或消失，动压承载条件随之变化。']),
('05','螺栓连接','连接',[(5,71)],[(6,100)],
...
['为什么螺栓总拉力一般不等于预紧力加全部工作力？','横向普通螺栓连接的抗滑条件与螺栓强度是什么关系？','外力绕螺栓组形心产生扭矩时，远端螺栓附加载荷通常怎样变化？'],
['接合面未分离时，工作力同时造成螺栓拉力增加和被连接件压缩力减少。','前者确定所需夹紧力，后者校核形成夹紧力后的螺栓；两步不能省略。','在常用等刚度弹性模型中与到形心的距离成正比，方向沿该点圆周切向。']),
('06','螺旋传动','连接',[(5,103)],[(6,118)],
...
['双线螺纹导程与螺距是什么关系？','为什么高效率与自锁往往需要权衡？','长而细的受压丝杠除材料强度外还应检查什么？'],
['导程为螺距的2倍。','升角相对摩擦角增大，有利于驱动效率，却更容易被反向驱动。','压杆稳定性，并检查相应支承边界条件。']),
('07','键花键与销连接','连接',[(6,115)],[(7,123)],
...
['普通平键的主要工作面在哪里？','平键能否替代轴肩承担所有轴向定位功能？','键连接校核后，轴的疲劳计算为什么仍要考虑键槽？'],
['键的两侧面。','通常不能，需由轴肩、套筒、挡圈等恰当结构实现。','键槽引入应力集中并改变截面，影响轴的疲劳强度。']),
('08','过盈铆焊胶连接','连接',[(7,129)],[(8,130),(9,140)],
...
['过盈量是否越大越可靠？','为什么胶接接头形状影响承载？','焊缝计算前首先需要识别什么？'],
['不是，还受轴与轮毂的强度以及装配条件约束。','形状会改变胶层剪切、剥离和局部应力分布。','焊缝形式、有效承载截面与外载方向。']),
('09','带传动','传动',[(8,155)],[(11,176)],
...
['弹性滑动与打滑的根本区别是什么？','轴上载荷为什么通常不等于有效拉力？','增加初拉力为什么有利也有弊？'],
['前者来自弹性伸缩差，后者源于所需传力超过摩擦能力。','前者由两边拉力的矢量合成决定，后者是两边拉力的差。','可提高摩擦传力能力，但会增加带和轴承负担，并可能缩短寿命。']),
('10','链传动','传动',[(9,177)],[(14,280)],
...
['链传动平均传动比准确是否意味着速度绝对均匀？','链为什么通常不需要像摩擦带那样大的预紧？','降低多边形效应可以从哪些参数入手？'],
['不意味着，存在多边形效应引起的瞬时波动。','它依靠啮合传力，张紧主要用于维持良好工作状态。','在约束允许时合理增加小链轮齿数、选较小节距，并控制速度。']),
('11','齿轮传动','传动',[(10,197)],[(12,204)],
...
['齿面点蚀与齿根折断分别用什么准则？','斜齿轮的轴向分力会影响后续哪些设计？','齿宽增加为什么不能无条件按比例提高承载能力？'],
['分别用齿面接触疲劳强度和齿根弯曲疲劳强度。','轴承轴向载荷、轴向定位、支承配置及相关结构。','实际齿向载荷分布可能变差，还受轴、支承和制造误差影响。']),
('12','蜗杆传动','传动',[(11,251)],[(13,257)],
...
['蜗杆副为什么需要单独考虑热平衡？','蜗杆头数改变会牵动哪些参数或性能？','满足蜗轮强度为什么还要检查蜗杆刚度？'],
['滑动摩擦损失可能较大，温升会影响油膜、材料和工作能力。','传动比、导程角、效率及反向驱动性质等。','蜗杆变形会影响接触和载荷分布，导致工作不良。']),
('13','轴的结构与强度','轴系',[(15,371)],[(16,309)],
...
['最大弯矩截面为什么不一定最危险？','转轴与传动轴的主要受载差别是什么？','画轴受力图时为什么不能只保留圆周力？'],
['局部直径、应力集中和扭矩等可能使其他截面更危险。','转轴同时承受弯矩和转矩；传动轴主要传递转矩。','径向及轴向分力也会影响支承、弯矩和轴向定位。']),
('14','滚动轴承','轴系',[(13,317)],[(18,359)],
...
['基本额定寿命中的10代表什么？','额定动载荷 C 能否当作所有工况下的最大允许力？','为什么两个轴承不能默认轴向力各分一半？'],
['对应基本额定寿命时约10%的同批轴承发生疲劳失效，可靠度为90%。','不能，它是与规定基本额定寿命和条件关联的承载参数。','安装方向、内部轴向作用、外载和支承配置决定实际分配。']),
('15','滑动轴承','轴系',[(12,285)],[(17,333)],
...
['径向滑动轴承平均压强的面积取什么？','通过 pv 校核能否证明全程都有完整油膜？','动压轴承油温变化为什么会反馈到承载能力？'],
['取轴颈直径与轴承宽度的乘积，即投影面积 dB。','不能，pv 是条件性验算；完整油膜还需检查动压形成条件和最小膜厚等。','温度改变黏度，进而影响油膜压力、厚度及摩擦发热。']),
('16','联轴器与离合器','轴系',[(14,353)],[(19,404)],
...
['挠性联轴器是否都带弹性元件？','联轴器选型除转矩还要检查什么？','摩擦离合器反复接合时为什么要考虑发热？'],
['不是，教材区分无弹性元件和有弹性元件的挠性联轴器。','转速、轴孔尺寸、轴伸、补偿需求及安装维护条件等。','接合过程存在滑摩，机械能转化为热。']),
('17','弹簧','其他',[(16,401)],[(20,431)],
...
['轴向受压的螺旋弹簧丝主要承受什么应力？','为什么有效圈数不能直接等同总圈数？','强度合格但刚度不对的弹簧是否满足设计？'],
['通常主要是扭转剪应力。','端部支承圈不一定参与有效弹性变形。','不满足，给定载荷下的变形和功能可能不符合要求。']),
('18','机架箱体与结构工艺','其他',[(17,421)],[(21,455)],
...
['箱体刚度不足为什么会影响齿轮寿命？','加肋为何必须考虑载荷路径？','结构改错题怎样写出完整理由？'],
['支承和轴线关系变化会导致啮合偏载等问题。','肋板应支撑主要变形方向，随意加肋未必有效且可能影响工艺。','明确功能、后果和改法，并检查修改是否造成新干涉。']),
('19','减速器与综合设计','综合',[(18,429)],[(15,297)],
...
['为何每根轴应分别列出功率、转速和转矩？','换轴承后为什么可能需要重新画弯矩图？','总传动比满足要求是否意味着分配方案合格？'],
['各级转速和效率不同，所传转矩及后续载荷也不同。','型号或结构改变可能改变支承位置、跨距和受力位置。','还需检查尺寸、承载、速度、润滑和结构布置等约束。']),
('20','摩擦轮与变速器','传动',[(18,433)],[(10,163)],
...
['压紧力提高为什么可能增加轴承负担？','摩擦轮与带传动共用什么传力原理？','无级变速器只在一个速比下合格是否足够？'],
['接触处法向力通过轮轴传给支承。','利用接触面摩擦传递圆周力。','不够，需要考虑工作范围中不同速比下的工况约束。']),
]

by_id = {t[0]: t for t in topics}
def name(i): return f'{i}-{by_id[i][1]}'
def link(i): return f'[[{name(i)}]]'
def source(book, chapter, page):
    offset = 10 if book == '濮良贵' else 15
    return f'[[《机械设计》{book}.pdf#page={page+offset}|{book}版 第{chapter}章，书内 p.{page}／PDF {page+offset}]]'

edges = [
('01','02','由失效准则确定强度计算'),('01','03','按功能与失效选择材料'),('01','04','由工作条件选择耐磨与润滑准则'),
('03','02','材料、表面和制造影响疲劳极限'),('03','11','热处理改变许用应力与准则侧重'),('03','13','材料和工艺约束轴的结构'),
('04','09','摩擦能力限制有效拉力'),('04','15','油膜形成决定计算路径'),('04','12','滑动损失引出发热与润滑'),('04','20','摩擦传力要求压紧力'),
('02','05','变载螺栓需要疲劳评价'),('02','11','齿根弯曲与齿面接触疲劳'),('02','13','轴肩键槽影响疲劳安全系数'),('02','14','接触疲劳引出额定寿命'),('02','17','变载弹簧需要疲劳评价'),
('05','02','连接刚度改变螺栓应力幅'),('05','18','螺栓连接维持箱体接合与紧固'),('06','04','当量摩擦决定效率与自锁'),
('07','13','键槽引入应力集中'),('13','07','轴径和轮毂长度约束键尺寸'),('08','03','连接工艺影响材料和制造选择'),('08','13','过盈与轮毂连接引入应力和装配约束'),
('09','13','带轮两边拉力形成轴上载荷'),('10','13','链轮载荷传给轴与支承'),('09','10','对比弹性滑动与多边形效应'),('20','13','压紧力增加轴和支承载荷'),
('11','13','啮合分力决定轴的载荷'),('11','14','径向与轴向分力决定支承载荷'),('13','11','轴变形反馈到齿向载荷分布'),
('12','13','蜗杆蜗轮分力决定轴的载荷'),('12','14','轴向载荷影响轴承配置'),('12','18','散热要求约束箱体设计'),
('13','14','支承反力是轴承计算输入'),('14','13','安装尺寸与支承位置约束轴结构'),('15','13','油膜和支承宽度影响轴系工作'),
('14','04','润滑密封影响轴承实际工作'),('15','04','油温改变黏度并反馈油膜'),('16','07','轴端传矩需要恰当轮毂连接'),('16','13','轴孔与不对中约束轴端设计'),('16','04','摩擦离合器需要摩擦和热分析'),
('17','01','刚度与变形必须满足功能'),('18','11','箱体刚度影响啮合对中'),('18','14','轴承座决定支承位置与精度'),
('19','11','各轴动力参数决定齿轮输入'),('19','12','方案可选蜗杆减速'),('19','13','汇总传动载荷设计轴系'),('19','18','传动和轴系决定箱体布置'),('19','16','动力接口需要联接与选型'),('20','19','变速原理扩展传动方案')
]

for i,title,group,pu,qiu,body,qs,ans in topics:
    refs = [source('濮良贵',c,p) for c,p in pu] + [source('邱宣怀',c,p) for c,p in qiu]
    incoming=[f'- {link(a)} → 本节点：{label}。' for a,b,label in edges if b==i]
    outgoing=[f'- 本节点 → {link(b)}：{label}。' for a,b,label in edges if a==i]
    text=f'''---
tags: [机械设计, {group}]
掌握状态: 未开始
---
...
'''+ '\n'.join(incoming+outgoing) + '\n\n## 闭卷自测\n\n' + '\n'.join(f'{k+1}. {q}' for k,q in enumerate(qs)) + '\n\n<details>\n<summary>展开参考要点</summary>\n\n' + '\n'.join(f'{k+1}. {a}' for k,a in enumerate(ans)) + '\n\n</details>\n\n## 本轮复习记录\n\n- [ ] 能解释原理和失效\n- [ ] 能判断公式的适用条件\n- [ ] 能独立完成代表题或结构分析\n- [ ] 能说出至少两条跨章联系\n\n错题链接：\n\n下次回忆时最需要回答的问题：\n'
    (TOP / f'{name(i)}.md').write_text(text,encoding='utf-8')

def write(file,text): (ROOT/file).write_text(text.strip()+'\n',encoding='utf-8')

write('00-机械设计知识网络总览.md', '''
---
tags: [机械设计, 知识地图]
---
...
pu_chapters=[('绪论',3),('机械设计总论',5),('机械零件的强度',27),('摩擦、磨损及润滑概述',53),('螺纹连接和螺旋传动',71),('键、花键、无键连接和销连接',115),('铆接、焊接、胶接和过盈连接',129),('带传动',155),('链传动',177),('齿轮传动',197),('蜗杆传动',251),('滑动轴承',285),('滚动轴承',317),('联轴器和离合器',353),('轴',371),('弹簧',401),('机架和箱体简介',421),('减速器和变速器',429)]
q_chapters=[('机械设计概论',1),('机械零件的工作能力和计算准则',11),('机械零件的疲劳强度',36),('摩擦、磨损、润滑',58),('机械常用材料和制造工艺性',79),('螺纹联接',100),('键、花键、销、成形联接',123),('过盈联接',130),('铆接、焊接、胶接',140),('摩擦轮传动',163),('带传动',176),('齿轮传动',204),('蜗杆传动',257),('链传动',280),('减速器',297),('轴',309),('滑动轴承',333),('滚动轴承',359),('联轴器和离合器',404),('弹簧',431),('机架零件',455)]
txt='''# 两书章节与页码对照
...
|---|---|---|
'''
for i,title,group,pu,qiu,*_ in topics:
    txt+=f"| {link(i)} | {'；'.join(source('濮良贵',c,p) for c,p in pu)} | {'；'.join(source('邱宣怀',c,p) for c,p in qiu)} |\n"
txt+='''
## 需要重点对读的差异
...
'''
txt+='\n'.join(f'- {source("濮良贵",j,p)}：{title}' for j,(title,p) in enumerate(pu_chapters,1))
txt+='\n\n### 邱宣怀版：21章\n\n'
txt+='\n'.join(f'- {source("邱宣怀",j,p)}：{title}' for j,(title,p) in enumerate(q_chapters,1))
txt+='\n\n本表覆盖两书全部章级主题；各章细节在专题卡中列出复习分支，完整小节名称仍以原书目录为准。\n'
write('01-两书章节与页码对照.md',txt)
...
# 原生 Obsidian Canvas：各列按照学习层级排列，保留所有可解释关系。
positions={
 '01':(0,0),'02':(0,510),'03':(0,1020),'04':(0,1530),
 '05':(650,0),'06':(650,510),'07':(650,1020),'08':(650,1530),
 '09':(1300,0),'10':(1300,510),'11':(1300,1020),'12':(1300,1530),'20':(1300,2040),
 '13':(1950,0),'14':(1950,510),'15':(1950,1020),'16':(1950,1530),
 '19':(2600,0),'18':(2600,510),'17':(2600,1020)
}
colors={'基础':'4','连接':'3','传动':'5','轴系':'6','其他':'2','综合':'1'}
nodes=[{'id':'intro','type':'text','x':0,'y':-470,'width':3080,'height':200,'text':'# 机械设计 · 双教材知识网络\n濮良贵第十版 × 邱宣怀第四版\n从左向右：共用基础 → 连接 → 传动 → 轴系 → 系统与其他。箭头标签表示输入、约束或反馈。打开卡片进入原书入口、自测和完整说明。先追踪 齿轮→轴→轴承→箱体→齿轮 的回路。'}]
for x,label in [(0,'共用基础'),(650,'连接与紧固'),(1300,'运动与动力传递'),(1950,'轴系与支承'),(2600,'系统与其他')]:
 nodes.append({'id':f'col{x}','type':'text','x':x,'y':-190,'width':480,'height':100,'text':'## '+label})
for i,title,group,*_ in topics:
 x,y=positions[i]
 nodes.append({'id':'n'+i,'type':'file','file':f'知识网络/专题/{name(i)}.md','x':x,'y':y,'width':480,'height':350,'color':colors[group]})
ces=[]
for j,(a,b,label) in enumerate(edges):
 x1,y1=positions[a];x2,y2=positions[b]
 if x2>x1:fs,ts='right','left'
 elif x2<x1:fs,ts='left','right'
 elif y2>y1:fs,ts='bottom','top'
 else:fs,ts='top','bottom'
 ces.append({'id':f'e{j:03d}','fromNode':'n'+a,'fromSide':fs,'toNode':'n'+b,'toSide':ts,'toEnd':'arrow','label':label})
write('机械设计知识网络.canvas',json.dumps({'nodes':nodes,'edges':ces},ensure_ascii=False,indent=2))

# 把全部学习资料编为一份便携正文，常规阅读器也可全文检索。
parts=[]
for fn in ['00-机械设计知识网络总览.md','01-两书章节与页码对照.md','02-跨章节解题链.md','03-关键公式与适用条件.md','04-复习路径与掌握检查.md']:
 parts.append((ROOT/fn).read_text(encoding='utf-8'))
for i,*_ in topics:parts.append((TOP/f'{name(i)}.md').read_text(encoding='utf-8'))
parts.append((ROOT/'06-资料依据与使用说明.md').read_text(encoding='utf-8'))
write('机械设计知识体系-完整阅读版.md','\n\n---\n\n'.join(parts))

print(json.dumps({'专题':len(topics),'关系':len(edges),'自测题':sum(len(t[-2]) for t in topics),'canvas_nodes':len(nodes),'文件数':len(list(ROOT.rglob('*.md')))},ensure_ascii=False))
